...
export default function AppHomeNavPage() {
  return <CrudPage title="首页导航" listUrl="/admin/app/home-nav" createUrl="/admin/app/home-nav"
    searchClient searchPlaceholder="名称、链接"
    deleteUrl={r => `/admin/app/home-nav/${r.id}`} updateUrl={r => `/admin/app/home-nav/${r.id}`} batchDelete
