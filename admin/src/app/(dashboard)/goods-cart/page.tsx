...
export default function GoodsCartPage() {
  const [list, setList] = useState<{id:number;user_id:number;goods_id:number;quantity:number;created_at:string}[]>([])
  ...
  return (<><Typography.Title level={4}>购物车</Typography.Title>
