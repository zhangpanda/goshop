...
export default function LayoutPage() {
  return <CrudPage title="首页布局" listUrl="/admin/layouts" createUrl="/admin/layouts" searchable
    ...
    formItems={() => (<><Form.Item name="name" label="名称" rules={[{required:true}]}><Input /></Form.Item><Form.Item name="type" label="类型"><Select options={[{value:'home',label:'首页'},{value:'category',label:'分类'},{value:'user',label:'用户中心'}]} /></Form.Item><Form.Item name="data" label="配置(JSON)"><Input.TextArea rows={8} /></Form.Item></>)} modalWidth={700} />
}
